...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555162, ; uint32_t android_runtime_jnienv_class_token (0x20002da)
	i32 100670980, ; uint32_t jnienv_initialize_method_token (0x6001e04)
	i32 100670979, ; uint32_t jnienv_registerjninatives_method_token (0x6001e03)
...
@dso_cache = dso_local local_unnamed_addr global [528 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 620112892644381406, ; hash 0x89b1563eeb552de, from name: FogOfWar.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FogOfWar.dll.so
		ptr null; void* handle (0x0)
	}, ; 15
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3437486644449934017, ; hash 0x2fb467e3fa967ac1, from name: libaot-FogOfWar.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FogOfWar.dll.so
		ptr null; void* handle (0x0)
	}, ; 93
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.54_name, ; name: libaot-System.Collections.Immutable.dll.so
		ptr null; void* handle (0x0)
	}, ; 99
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 8181426186214326493, ; hash 0x718a43c4f16240dd, from name: aot-FogOfWar
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FogOfWar.dll.so
		ptr null; void* handle (0x0)
	}, ; 216
	...
	%struct.DSOCacheEntry {
		i64 16258131705718466833, ; hash 0xe1a07ca5a6dd6911, from name: FogOfWar
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FogOfWar.dll.so
		ptr null; void* handle (0x0)
	}, ; 466
	...
	%struct.DSOCacheEntry {
		i64 17509974172458944077, ; hash 0xf2ffecbcefae064d, from name: libaot-FogOfWar
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FogOfWar.dll.so
		ptr null; void* handle (0x0)
	}, ; 496
	...
	%struct.DSOCacheEntry {
		i64 18291886317785851233, ; hash 0xfdd9d5b103742561, from name: aot-FogOfWar.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FogOfWar.dll.so
		ptr null; void* handle (0x0)
	}, ; 521
...
@.env.3 = private unnamed_addr constant [37 x i8] c"7dffa585-e986-4aae-93fe-e5df731d58a7\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [17 x i8] c"com.fogofwar.app\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [23 x i8] c"libaot-FogOfWar.dll.so\00", align 16
...
@.DSOCacheEntry.54_name = private unnamed_addr constant [43 x i8] c"libaot-System.Collections.Immutable.dll.so\00", align 16
