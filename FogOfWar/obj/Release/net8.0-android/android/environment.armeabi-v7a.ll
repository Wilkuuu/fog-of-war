...
@dso_cache = dso_local local_unnamed_addr global [528 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 325574170, ; hash 0x1367de1a, from name: libaot-FogOfWar
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 893805356, ; hash 0x3546632c, from name: FogOfWar.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FogOfWar.dll.so
		ptr null; void* handle (0x0)
	}, ; 106
	...
	%struct.DSOCacheEntry {
		i64 1897975661, ; hash 0x7120cf6d, from name: FogOfWar
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FogOfWar.dll.so
		ptr null; void* handle (0x0)
	}, ; 219
	...
	%struct.DSOCacheEntry {
		i64 1942786094, ; hash 0x73cc902e, from name: libaot-FogOfWar.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FogOfWar.dll.so
		ptr null; void* handle (0x0)
	}, ; 227
	...
	%struct.DSOCacheEntry {
		i64 3547528287, ; hash 0xd372fc5f, from name: aot-FogOfWar.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FogOfWar.dll.so
		ptr null; void* handle (0x0)
	}, ; 436
	...
	%struct.DSOCacheEntry {
		i64 3758784388, ; hash 0xe00a7f84, from name: aot-FogOfWar
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FogOfWar.dll.so
		ptr null; void* handle (0x0)
	}, ; 462
